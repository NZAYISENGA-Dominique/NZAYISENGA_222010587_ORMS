		...
		public Loginapplication() {
			...
			login.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					 SwingUtilities.invokeLater(() -> new MainForm("TO Online recruitment management system"));
			...
			JButton forgotPasswordButton = new JButton("Forgot Password?");
		     forgotPasswordButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent e) {
		             ...
		             String email = JOptionPane.showInputDialog(Loginapplication.this, "Enter your email:");
		             if (email != null && !email.isEmpty()) {
		                 ...
		                 JOptionPane.showMessageDialog(Loginapplication.this, "A password reset link has been sent to your email.");
		             } else {
		                 JOptionPane.showMessageDialog(Loginapplication.this, "Please enter a valid email.");
		             }
		         }
		     });
		     ...
		     createAccountButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent e) {
		        	 ...
		        	 Loginapplication registrationForm = new Loginapplication();
